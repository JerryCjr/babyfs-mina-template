...
const targetDirectory = 'dist/node_modules';
...
function resolving(filePath, externalPath) {
  ...
  if (fileHelper.existSync(externalPath)) {
  ...
  assert.warn('源文件的路径', filePath);
  assert.warn('copyDestImportFile', copyDestImportFile);
